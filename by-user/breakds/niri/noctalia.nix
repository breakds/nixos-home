...
let
  noctaliaSettings = {
    ...
    wallpaper = {
      ...
      directory = "/home/breakds/Pictures/Wallpapers";
...
in {
  xdg.configFile = {
    ...
    "noctalia/colors.json".text = builtins.toJSON noctaliaColors;
    "noctalia/plugins.json".text = builtins.toJSON noctaliaPlugins;
  };
}
